...
def circuit_builder(Circuit, q_list, state_1, state_2):
    if state_1 == "GHZ":
        ...
        Circuit.x(q_list[0])                        
        Circuit.ry(-0.955316618124509, q_list[1])
        Circuit.cz(q_list[0],q_list[1])           
        Circuit.ry(0.955316618124509, q_list[1])            
        Circuit.ry(-np.pi/4, q_list[2])      
        Circuit.cz(q_list[1],q_list[2])
        Circuit.ry(np.pi/4, q_list[2])                                   
        Circuit.cx(q_list[2],q_list[1])
        Circuit.cx(q_list[2],q_list[0])
        Circuit.cx(q_list[1],q_list[0])
